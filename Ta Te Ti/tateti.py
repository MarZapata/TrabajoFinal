...
def dibujarTablero(tablero):
    ...
    print(' ')
    print('Para jugar tenés que tipear el número que corresponde a la posición')
    print('en que querés ubicar tu jugada:')
    print(' ')
    print(' 7 | 8 | 9')               
    print('-----------')
    print(' 4 | 5 | 6')
...
while True:
    ...
    while juegoEnCurso:
        if turno == 'El jugador':
            ...
            if esGanador(elTablero, letraComputadora):
                dibujarTablero(elTablero)
                print('¡La computadora te ganó! Mejor suerte la próxima.')
                print(' ')
                juegoEnCurso = False
            else:
                if tableroCompleto(elTablero):
    ...
    if not jugarDeNuevo():
        print('Este juego es un arreglo realizado por Martín Zapata para Tecno3F')
        print('El código base está sacado de inventwithpython.com')
        print('Gracias por jugar con él')
        break